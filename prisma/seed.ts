...
async function main() {
  ...
  const students = await Promise.all([
    prisma.student.create({
      data: {
        ...
        teacherId: teachers[0].id,
        guardians: ['Sarah Thompson', 'John Thompson'],
        iepDates: ['2023-09-01', '2024-03-01'],
    ...
    prisma.student.create({
      data: {
        ...
        teacherId: teachers[1].id,
        guardians: ['Michelle Chen', 'David Chen'],
        iepDates: ['2023-10-15'],
    ...
    prisma.student.create({
      data: {
        ...
        classroomId: classrooms[1].id,
        teacherId: teachers[1].id,
        guardians: ['Ashley Williams', 'Michael Williams'],
        iepDates: ['2023-11-01', '2024-05-01'],
    ...
    prisma.student.create({
      data: {
        ...
        classroomId: classrooms[0].id,
        teacherId: teachers[0].id,
        guardians: ['Priya Patel', 'Raj Patel'],
        iepDates: ['2024-01-15'],
  ...
  const scheduleEvents = [
    ...
    },
    {
      ...
      endTime: '10:15',
      location: 'Speech Room',
      studentIds: [students[1].id, students[3].id],
      teacherId: teachers[1].id,
      sessionType: 'Group',
      status: 'Seen',
    },
